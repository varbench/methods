...
python Run_RNNWF_2DHeis.py --J2 1.0 --L 14 --lr 1e-5 --RNN_symmetry c2dsym --numunits 300 --Nannealing 0 --Nwarmup 0 --Nconvergence 5000 --numsamples 100 --learning_rate_fixed True --lrthreshold_conv 1e-5 

python Run_RNNWF_2DHeis.py --J2 1.0 --L 16 --lr 1e-5 --RNN_symmetry c2dsym --numunits 300 --Nannealing 0 --Nwarmup 0 --Nconvergence 2000 --numsamples 100 --learning_rate_fixed True --lrthreshold_conv 1e-5 
