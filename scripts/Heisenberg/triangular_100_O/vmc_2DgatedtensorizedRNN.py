...
python Run_RNNWF_2DHeis.py --J2 1.0 --L 6 --mag_fixed True --RNN_symmetry nosym --numunits 300 --numsamples 100 --T0 0.25 --lrthreshold 5e-4 --Nwarmup 1000 --Nannealing 10000 --lrthreshold_conv 5e-5 --numsamples_conv 100 --Nconvergence 25000
python Run_RNNWF_2DHeis.py --J2 1.0 --L 6 --mag_fixed True --RNN_symmetry c2dsym --numunits 300 --numsamples 100 --T0 0.25 --lrthreshold 5e-4 --Nannealing 10000 --lrthreshold_conv 5e-5 --numsamples_conv 100 --Nconvergence 50000 --lrdecaytime_conv 2000
