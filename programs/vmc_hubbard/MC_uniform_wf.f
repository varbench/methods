      program turbohub      
      implicit none 
      integer*4 nx,idim,ivc,indt,izeth,L,nelm,nwm,npm,nelm2
     ...
     >,nraw,iflag,ind
      parameter(nx=45,L=270,idim=2,ivc=2,izeth=ivc*idim,indt=2*izeth
     >,nelm=L,nwm=2,npm=200,npsov=npm*npm)
