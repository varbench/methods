...
int NSPar; // spin parity is even or odd
...
int NCisAjsCktAltCmuAnuCovApv,   **CisAjsCktAltCmuAnuCovApvIdx;   /* 4-body green's function */
int NCisAjsCktAltCmuAnuCovApvDC, **CisAjsCktAltCmuAnuCovApvDCIdx; /* direct 4-body greens function */
...
double complex *PhysCisAjsCktAlt; /* [NCisAjsCktAlt] */
double complex *PhysCisAjsCktAltDC; /* [NCisAjsCktAltDC] */
double complex *PhysCisAjsCktAltCmuAnuCovApv; /* [NCisAjsCktAltCmuAnuCovApv] */
double complex *LocalCisAjs; /* [NCisAjs] */
double complex *LocalCisAjsCktAlt; /* [NCisAjsCktAlt] */
...
FILE *FileCisAjsCktAltCmuAnuCovApv;
FILE *FileCisAjsCktAltCmuAnuCovApvDC;
FILE *FileLS;
FILE *FileLSQQQQ;
FILE *FileLSQCisAjsQ;
