...
static char cKWListOfFileNameList[][D_CharTmpReadDef]={
  ...
  "OneBodyG", "TwoBodyG", "TwoBodyGEx", "FourBodyGEx",
...
enum KWIdxInt{
  ...
  KWOneBodyG, KWTwoBodyG, KWTwoBodyGEx,KWFourBodyGEx,
...
enum ParamIdxInt{
  ...
  //RBM
  IdxSPGaussLeg, IdxSPStot, IdxSPar, IdxMPTrans,
  ...
  IdxNTwoBodyGEx, IdxNFourBodyGEx, IdxNInterAll, IdxNQPOptTrans,
  IdxSROptCGMaxIter,
